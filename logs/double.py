...
if __name__ == "__main__":
    ...
    train_data_2 = exact_traindata(
        '../dataset/train_gradient_images',
        (28, 28))
    train_labels, train_class = label_exacted(
        '../dataset/train_AES')

    # 加载验证及数据（远程服务器运行)
    # 改动，添加上了路径
    test_data_1 = exact_traindata('../dataset/val_AES', (28, 28))
    test_data_2 = exact_traindata('../dataset/val_gradient_images',
                                  (28, 28))
    ...
    # 训练模型
    model.fit([train_data_1, train_data_2], train_labels, epochs=50, batch_size=64, validation_data=([test_data_1, test_data_2], test_labels),callbacks=[tensorboard_callback])
    ...
    # 保存模型
    #改动，添加上了路径
    model.save('C:/Users/LENOVO/Desktop/资料/双流卷积神经网络/dataset')
